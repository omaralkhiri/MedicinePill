...
public class UserOrderAdapter3 extends RecyclerView.Adapter<UserOrderAdapter3.userorder3ViewHolder> {
    private Context context;
    private List<Medicine> medicineList;
    private RequestQueue queue;
    public UserOrderAdapter3(Context context, List<Medicine>medicineList){
    ...
    @NonNull
    @Override
    public userorder3ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view  = inflater.inflate(R.layout.medicne_item_addordelete,parent,false);
        return new userorder3ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull userorder3ViewHolder holder, int position) {
    ...
    class userorder3ViewHolder extends RecyclerView.ViewHolder
    {

        private ImageView medicineImageView,addmedicine;
        private TextView nameTextView;
        private String URL="http://"+idinfo.getIpaddress()+"/health_app/AddMedicineINOrderList.php";

        public userorder3ViewHolder(View itemView) {
            super(itemView);
                    ...
                    StringRequest request=new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            if (response.trim().equals("true")) {
                                ...
                                Toast.makeText(context.getApplicationContext(), "This medicine has been added beforeThis medicine has been added before", Toast.LENGTH_SHORT).show();
                        }}
