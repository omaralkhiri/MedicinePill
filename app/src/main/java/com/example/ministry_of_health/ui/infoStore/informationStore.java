package com.example.ministry_of_health.ui.infoStore;
...
public class informationStore extends Fragment {
    ...
    public static informationStore newInstance() {
        return new informationStore();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        View view= inflater.inflate(R.layout.information_store_fragment, container, false);

        textname=view.findViewById(R.id.nametxt);
        textbirthday=view.findViewById(R.id.birthdaytxt);
        textcity=view.findViewById(R.id.citytxt);
        textidnumber=view.findViewById(R.id.idtxt);
        textgender=view.findViewById(R.id.gendertxt);
        textphone=view.findViewById(R.id.editTextTextPersonName);
        btnsign=view.findViewById(R.id.btnsignout5);
